...
- `scheduling_MIEdit_SD3_5.py`: MIEdit SA-Solver scheduler used by the editing pipeline.
- `run_pie_bench.py`: PIE-Bench evaluation entry point.
- `run_pie_bench_sequential.sh`: Sequential launcher for exact reproduction.
- `matric_calculator.py`: Metric computation utilities.
- `EXPERIMENT_CONFIG.md`: Published SD3.5 Medium experiment configuration.
...
- Our Benchmark: EditEval++ is available at <https://drive.google.com/file/d/11DB7StJpe4y5hJTEjLhAHOP8qWjO8hXW/view?usp=drive_link>.
